    ...
    <body data-bs-spy="scroll" data-bs-target="#navbarExample">
        ...
        <nav id="navbarExample" class="navbar navbar-expand-lg fixed-top navbar-light" aria-label="Main navigation">
            <div class="container">
                ...
                <a class="navbar-brand logo-text" href="index.html">Enaclas</a>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1 class="h1-large">Centro de Estudios <span class="replace-me">Enaclas, Enaclas, Enaclas</span></h1>
                    ...
                    <div class="col-lg-6">
                        <div class="image-container">
                            <img class="img-fluid" src="images/ReadingBooks.png" alt="alternative">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-xl-5">
                        <div class="text-container">
                            <h2>Gestiona las expectativas de tus alumnos y haz que confíen en ti</h2>
        ...
        <div class="basic-3">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h4>Cualquiera puede empezar a utilizar la aplicación con un mínimo de conocimientos</h4>
